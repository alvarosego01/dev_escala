...
<div id="new-home-2025">
    <div class="sections">
            ...
            <div class="section-row ">
                ...
                <div class=" row sct2">
                    <div class="mb-4 col-lg-4 col-md-12 box-internal">
                        <div class="card-box"
                            style="background-image: url('{!! App::setFilePath('/assets/images/illustrations/others/bg_testimonios_new-home_2025.png') !!}')">
        ...
        <section class="sectionParent customSection new-home-2025-7">
            <div style="background-image: url('{!! App::setFilePath('/assets/images/banners/bg_new-landing_home_escala_section_7.svg') !!}')" class="backgroundFull">
                <div class="section-row">
                    <section class="innerSectionElement sct2">
                        <div class="groupElements row">
