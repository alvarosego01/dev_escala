...
<div id="landing-LandingPagesOtto-bootstrap">
  ...
  <div class="sections">
    ...
    class="specialHeader">
      ...
      $parameters = array(
       ...
       'backgroundImage' => null,
        'overlayImage' => null,
        'image' => App::setFilePath('/assets/images/illustrations/otto/landings_otto-landing1.png'),
      ) ;
      @endphp
      ...
      $parameters = [
          ...
          'classSection' => 'LandingPagesOtto1',
          'enableTitle' => true,
    ...
    @php
    $parameters = array(
     'classSection' => 'LandingPagesOtto2 func',
 ...
 $parameters = array(
   'type' => 'regular',
  'classSection' => 'LandingPagesOtto3',
...
@endcontain_aio5
   ...
   <section class="customSection sectionParent LandingPagesOtto4 fullWidth">
  ...
  @php
  $parameters = [
      'classSection' => 'LandingPagesOtto5',
