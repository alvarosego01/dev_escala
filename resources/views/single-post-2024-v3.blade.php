{{--
    Template Name: [B] Blog - Single - 2024 - V3
...
@section('content')
<div id="single_blog_2024_v3" class="post-template">


    <div class="sections">

        <section id="lead-form" class="component-header-t1 bg-image overlay customSection sectionParent fullWidth threeCol single_blog_2024_v3 single_blog_2024_v3_0">
        ...
        <section class="w-full customSection sectionParent single_blog_2024_v3_1">
        ...
        <section class="customSection sectionParent single_blog_2024_v3 single_blog_2024_v3_11">
            <div class="section-row">
                <section class="innerSectionElement sct0">
                    <div class="containElements">
                        <div class="container">
