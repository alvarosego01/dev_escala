...
<div id="landing-emailMk-bootstrap">
  ...
  <div class="sections">
    ...
    if ( !isset($custom_header_title) || $custom_header_title == null ) {
        # code...
        $custom_header_title = '<span class="whiteColor"><span class="preTitle">Con los emails de Escala</span> <br class="space"> Genera más leads y mantén la <br class="DT_e"> comunicación con tus clientes</span>';
    }
