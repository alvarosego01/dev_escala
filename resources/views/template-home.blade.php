            ...
            <div class="groupElements row">
              <div class="col-md-12 col-lg-6 infoGroup">
                ...
                <div class="containerElements">
                  <h2 class="commonTitle blackColor">Crea increíbles<br> páginas sin programar</h2>
                  <p class="secondaryText grayColor">¡Y que queden hermosas!</p>
                  <a class="hiperButtonGray" href="">Conocer más</a>
                </div>
              ...
              <div class="col-md-12 col-lg-6 infoGroup">
                ...
                <div class="containerElements">
                  <h2 class="commonTitle blackColor">Organiza tus contactos <br> y gestiona procesos de venta </h2>
