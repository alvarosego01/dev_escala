    ...
    <div id="homeSection">
        <div class="sections">
            ...
            @header_t1([
                ...
                'overlay' => false,
                'classSection' => 'D_e threeCol homeSection_0 newHome',
                'title' => '
            ...
            @header_t1([
                'backgroundImageType' => true,
                'overlay' => false,
                'classSection' => 'MT_e threeCol homeSection_0 newHome',
                'title' => '
                    Acelera el crecimiento <br class="space">
                    ...
                    <section class="innerSectionElement sct1">
                        ...
                        <div class="containElements">
                            ...
                            <p class="primaryText grayColorTexts">
                                ...
                                paso a paso para que <br class="DT_e">
                    ...
                    <section class="innerSectionElement sct2">
                        ...
                        <div class="containElements">
                            <div class="containerImage">
                                ...
                                <img class="D_e" src="{!! App::setFilePath('/assets/images/illustrations/others/home_imple.png') !!}" loading="lazy">
                                <img class="MT_e" src="{!! App::setFilePath('/assets/images/illustrations/others/home_imple_mobile.png') !!}" loading="lazy">
            ...
            <section class="component-info-multiple-cards-T2 customSection sectionParent homeSection_7 ">
                ...
                <div class="section-row">
                    ...
                    <section class="innerSectionElement sct2">
                        <div class="groupElements row">
                            ...
                            <div class="image col-md-12 col-lg-6">
                                <div class="containerImage">
                                    <img class="D_e" src="{!! App::setFilePath('/assets/images/person/am/am_back_circle.png') !!}" loading="lazy">
                                    <img class="MT_e" src="{!! App::setFilePath('/assets/images/person/am/am_home_escala.png') !!}" loading="lazy">
                    ...
                    <section class="innerSectionElement sct2">
                        <div class="groupElements row">
                            ...
                            <div class="info col-md-12 col-lg-8">
                                ...
                                <p class="text">
                                    Descubre lo que Escala puede hacer <br class="MT_e">
                                    por ti y tu empresa
                                </p>
