...
30min o menos
 ...
 --}}
        ...
        <div class="specialOverlay right">
        ...
        <span class="items">
            <span>
                <img class="checkIcon" src="' .
                    App::setFilePath('/assets/images/illustrations/others/Vector-check-orange.png') .
                    '" alt="">
                Los contactos que se registren se guarden automáticamente en tu base de datos
            </span>
            <span>
                <img class="checkIcon" src="' .
                    App::setFilePath('/assets/images/illustrations/others/Vector-check-orange.png') .
                    '" alt="">
                Puedas automatizar flujos de comunicación post-registro por
                email y/o WhatsApp
            </span>
            <span>
                <img class="checkIcon" src="' .
