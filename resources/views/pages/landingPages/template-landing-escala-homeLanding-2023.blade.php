...
<div id="landing_homePage_2023">
    ...
    <div class="sections">
            ...
            @header_t1([
                ...
                'overlay' => false,
                'classSection' => 'desktopElement threeCol landing_homePage_2023_0 newHome',
                'title' => '
            ...
            @header_t1([
                'backgroundImageType' => true,
                'overlay' => false,
                'classSection' => 'mobileElement threeCol landing_homePage_2023_0 newHome',
                'title' => '
                    Acelera el crecimiento <br class="space">
            ...
            <section class="component-info-text-video-T1 customSection sectionParent landing_homePage_2023_1 ">
            ...
            <section class="component-info-text-image-T1 customSection sectionParent landing_homePage_2023_2 ">
            ...
            <section class="component-info-multiple-cards-T2 customSection sectionParent landing_homePage_2023_3 ">
            ...
            <section style="background-image: url({!! App::setFilePath('/assets/images/banners/background_space_4.png') !!})"
                class="customSection sectionParent landing_homePage_2023_4 ">
            ...
            <section class="customSection sectionParent landing_homePage_2023_5 ">
                ...
                <div class="section-row">
                    ...
                    <section class="innerSectionElement sct1">
                        ...
                        <div class="containElements">
                            ...
                            <p class="primaryText grayColorTexts">
                                Desde el día 1, tú y tu equipo reciben el apoyo de un Gerente de Éxito asignado que los guía
                                paso a paso para que <br class="desktopTabletElement">
                                aprovechen al máximo la plataforma. ¿Nuestro objetivo? Que tu empresa crezca rentablemente
                                con Escala
                            </p>
                        </div>
                    ...
                    <section class="innerSectionElement sct2">
                        ...
                        <div class="containElements">
                            <div class="containerImage">
                                ...
                                <img class="desktopElement" src="{!! App::setFilePath('/assets/images/illustrations/others/home_imple.png') !!}" loading="lazy">
                                <img class="mobileElement" src="{!! App::setFilePath('/assets/images/illustrations/others/home_imple_mobile.png') !!}" loading="lazy">
            ...
            <section class="component-info-multiple-cards-T2 customSection sectionParent landing_homePage_2023_6 ">
            ...
            style="background-image: url('{!! App::setFilePath('/assets/images/banners/background_sky_2.png.png') !!}')"
                class="component-info-text-image-T1 customSection sectionParent landing_homePage_2023_8 ">
                    ...
                    <section class="innerSectionElement sct2">
                        <div class="groupElements row">
                            ...
                            <div class="info col-md-12 col-lg-6">
                                ...
                                <p class="text">
                                    A más clientes ideales e inicia la relación comercial <br class="desktopTabletElement">
                                    capturando su contacto con anuncios digitales, landing <br
                                        class="desktopTabletElement">
                                    pages y formularios
                                </p>
            ...
            <section class="component-info-text-image-T1 customSection sectionParent landing_homePage_2023_9 ">
            ...
            <section style="background-image: url({!! App::setFilePath('/assets/images/banners/background_space_3.png') !!})"
                class="component-info-text-image-T1 customSection sectionParent landing_homePage_2023_10 ">
