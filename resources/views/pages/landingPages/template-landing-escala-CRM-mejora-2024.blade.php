        ...
        <section style="background-image: url({!! App::setFilePath('/assets/images/banners/bg-landing-crm-mejora03.svg') !!})" class="customSection sectionParent  landing_CRM_2024_9">
            <div class="section-row">
                <div class="containElements">
                    ...
                    [
                    'img_alt' => null,
                    'img' => App::setFilePath('/assets/images/illustrations/others/icon_crm_automatizaciones.png'),
                    ...
                    <div class="containElements">
                        ...
                        <div class="row">
                            <div class="col-md-12 col-lg-4 cardParent column-1">
                                <div class="card">
                                    <div class="card-body">
                                        <div style="background-image: url({!! App::setFilePath('/assets/images/overlays/landing_crm_top_card.svg') !!})" class="top-pill">Gerente de <br class="space">Éxito
                                        </div>
                            ...
                            <div class="col-md-12 col-lg-4 cardParent column-2">
                                <div class="card">
                                    <div class="card-body">
                                        <div style="background-image: url({!! App::setFilePath('/assets/images/overlays/landing_crm_top_card.svg') !!})" class="top-pill">Especialista de <br class="space"> Implementación
                            ...
                            <div class="col-md-12 col-lg-4 cardParent column-3">
                                <div class="card">
                                    <div class="card-body">
                                        <div style="background-image: url({!! App::setFilePath('/assets/images/overlays/landing_crm_top_card.svg') !!})" class="top-pill">Soporte Técnico <br class="space"> en vivo por chat
                                        </div>
                            ...
                            <div class="col-md-12 col-lg-4 cardParent column-4">
                                <div class="card">
                                    <div class="card-body">
                                        <div style="background-image: url({!! App::setFilePath('/assets/images/overlays/landing_crm_top_card.svg') !!})" class="top-pill">Servicio de <br class="space"> Personalización
                                        </div>
                            ...
                            <div class="col-md-12 col-lg-4 cardParent column-5">
                                <div class="card">
                                    <div class="card-body">
                                        <div style="background-image: url({!! App::setFilePath('/assets/images/overlays/landing_crm_top_card.svg') !!})" class="top-pill">Capacitación a<br class="space"> Líderes y Vendedores
                                        </div>
                                        ...
                                        <ul>
                                            ...
                                            <li>
                                                <div class="list-item">
                                                    <img src="{!! App::setFilePath('/assets/images/icons/icon_list_crm.png') !!}" loading="lazy">
                                                    <p>Masterclasses con el equipo de expertos de alto nivel de Escala</p>
                                                </div>
                                            </li>
                                            <li>
                                                <div class="list-item">
                                                    <img src="{!! App::setFilePath('/assets/images/icons/icon_list_crm.png') !!}" loading="lazy">
                                                    <p>Educación online a tu ritmo, con: minicursos, tutoriales y más.</p>
                                                </div>
                                            </li>
