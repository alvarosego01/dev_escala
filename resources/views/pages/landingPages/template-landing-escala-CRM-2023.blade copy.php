<div id="landing_CRM_2023">
    ...
    <div class="sections">
        ...
        <section style="background-image: url({!! App::setFilePath('/assets/images/banners/bg_landing_CRM_3.svg') !!})" class="customSection sectionParent landing_CRM_2023_9">
        ...
        <section class='w-full customSection sectionParent landing_CRM_2023_11'>
        ...
        <section style="background-image: url({!! App::setFilePath('/assets/images/banners/bg_landing_CRM_1.svg') !!})" class="customSection sectionParent landing_CRM_2023_12">
        ...
        <section class='w-full customSection sectionParent landing_CRM_2023_13'>
        ...
        <section style="background-image: url({!! App::setFilePath('/assets/images/banners/bg_landing_CRM_4.svg') !!})" class='w-full customSection sectionParent landing_CRM_2023_14'>
