...
<div id="subPage_alliances_2022">
  <div class="sections">
    ...
    $parameters = array(
     ...
     'overlay' => false,
     'classSection' => 'threeCol subPage_alliances_2022_0',
     'title' => '
  ...
  <section class="customSection sectionParent subPage_alliances_2022_01">
          ...
          <section class="innerSectionElement sct1">
            ...
            <div class="containElements">
              ...
              <h2 class="primaryTitle blackColor">
                ...
                <span class="greenBlueColor">Qué logran nuestros alliances</span>
              </h2>
              ...
              <div class="element col-md-12 col-lg-6">
                <div class="containElements">
                  ...
                  <p class="text">
                    ...
                    nuestro equipo de alliances, logras: <br class="space">
...
$parameters = [
    ...
    'classSection' => 'subPage_alliances_2022_02',
    'enableTitle' => true,
    'titlePrincipal' => '
...
<section class="customSection sectionParent subPage_alliances_2022_03">
...
$parameters = [
    'type' => 'backgroundColor',
    'classSection' => 'subPage_alliances_2022_04',
    'enableTitle' => true,
    'titlePrincipal' => '
    ...
    'elements' => [
        [
            'img_alt' => null,
            'img' => App::setFilePath('/assets/images/illustrations/others/count_alliances_item_1.png'),
            'title' => '
            Aplica
            ',
            'text' => '
        ...
        [
            'img_alt' => null,
            'img' => App::setFilePath('/assets/images/illustrations/others/count_alliances_item_2.png'),
            'title' => '
            Aprende
            ',
            'text' => '
        ...
        [
            'img_alt' => null,
            'img' => App::setFilePath('/assets/images/illustrations/others/count_alliances_item_3.png'),
            'title' => '
            Suscríbete
            ',
            'text'=> '
        ...
        [
            'img_alt' => null,
            'img' => App::setFilePath('/assets/images/illustrations/others/count_alliances_item_4.png'),
            'title' => '
            Certifícate
            ',
            'text' => '
        ...
        [
            'img_alt' => null,
            'img' => App::setFilePath('/assets/images/illustrations/others/count_alliances_item_5.png'),
            'title' => '
            Empieza a ganar
            ',
            'text' => '
...
<section class="customSection sectionParent subPage_alliances_2022_05">
...
@php
$parameters = [
    'classSection' => 'subPage_alliances_2022_06',
    'title' => '
