<div id="template_base_2023">
    <div class="sections">
        @header_t1([
            'backgroundImageType' => true,
            'overlay' => false,
            'classSection' => 'desktopElement threeCol templateBase_0 templateBase',
            'title' => '
        ...
        @header_t1([
            'backgroundImageType' => true,
            'overlay' => false,
            'classSection' => 'mobileElement threeCol templateBase_0 templateBase',
            'title' => '
                        Consigue más <br class="space"> leads de calidad  <br class="space">
                            <span style="color: #DEF3F5">para tu equipo comercial</span>
                        ',
            ...
            <div class="section-row">
                ...
                <section class="innerSectionElement sct2">
                    ...
                    <div class="groupElements row">
                        ...
                        <img src="{!! App::setFilePath('/assets/images/overlays/02-overlay-template-base-2023.png') !!}" alt="" class="overlaySky1">
                ...
                <section class="innerSectionElement sct2">
                        <div class="groupElements row">
                            <div class="col-md-12 col-lg-6">
                                <div class="containerImage">
                                    <img src="{!! App::setFilePath('/assets/images/illustrations/others/11-img-template-base-2023.png') !!}" loading="lazy">
                                </div>
                            </div>
        ...
        <section class="component-info-multiple-cards-T2 customSection sectionParent templateBase_3">
