<div id="analiticas_TB_2023">
    <div class="sections">
        ...
        @header_t1([
            ...
            'overlay' => false,
            'classSection' => 'threeCol analiticas-2023 analiticas-2023_0',
            'title' => '<span class="text-yellow">¡Medir</span><span class="text-blue">, medir</span>, medir! <br class="space">',
            'text' => '<span class="whiteColor">Lo que no se mide, no mejora. escala lo hace más<br class="space"> sencillo con dashboards amigables</span>',
            'threeCol' => true,
            'textForm' => 'Recibe un tour <br class="space"> guiado de Escala',
            'backgroundImage' => App::setFilePath('/assets/images/banners/10-analiticas_2023.png'),
            'overlayImage' => null,
            'image' => App::setFilePath('/assets/images/illustrations/others/01-analiticas_2023.png'),
        ...
        <section class="sectionParent customSection analiticas-2023_2">
            <div class="section-row">
                ...
                <section class="innerSectionElement sct2">
                    ...
                    <div class=" row groupElements">
                        ...
                        <div class="col-md-12 col-lg-6 column-image">
                            <div class="containerImage">
                                <img src="{!! App::setFilePath('/assets/images/illustrations/others/03-analiticas_2023.png') !!}" loading="lazy">
                            </div>
                        </div>
                    </div>
            </div>
        ...
        <section class="sectionParent customSection analiticas-2023_3">
            <div style="background-image: url('{!! App::setFilePath('/assets/images/banners/15-analiticas_2023.png') !!}')" class="backgroundFull">
            <div class="section-row">
                    ...
                    <div class=" row groupElements">
                        ...
                        <div class="col-md-12 col-lg-6 column-text">
                            ...
                            <div class="containElements">
                                ...
                                <h2 class="primaryTitle">
                                   <span>¡Esos anuncios digitales</span> <br class="space">
        ...
        <section class="sectionParent customSection analiticas-2023_4">
            <div class="section-row">
                    ...
                    <div class=" row groupElements">
                        ...
                        <div class="col-md-12 col-lg-6 column-text">
                            ...
                            <div class="containElements">
                                ...
                                <h2 class="primaryTitle">
                                    <span>¿Mis páginas podrían</span> obtener <br class="space">
                        ...
                        <div class="col-md-12 col-lg-6 column-image">
                            <div class="containerImage">
                                <img src="{!! App::setFilePath('/assets/images/illustrations/others/05-analiticas_2023.png') !!}" loading="lazy">
                            </div>
                        </div>
                    </div>
            </div>
        ...
        <section class="sectionParent customSection analiticas-2023_5">
            <div class="section-row">
                ...
                <section class="innerSectionElement sct1">
                    ...
                    <div class=" row groupElements">
                        <div class="col-md-12 col-lg-6 column-image">
                            <div class="containerImage">
                                <img src="{!! App::setFilePath('/assets/images/illustrations/others/06-analiticas_2023.png') !!}" loading="lazy">
                            </div>
                        </div>
                        <div class="col-md-12 col-lg-6 column-text">
                            ...
                            <div class="containElements">
                                ...
                                <h2 class="primaryTitle">
                                    <span>"Esa campaña de emails</span> <br class="space">
        ...
        <section class="sectionParent customSection analiticas-2023_6">
            <div style="background-image: url('{!! App::setFilePath('/assets/images/banners/13-analiticas_2023.png') !!}')" class="backgroundFull">
            <div class="section-row">
                    ...
                    <div class=" row groupElements">
                        <div class="col-md-12 col-lg-6 column-text">
                            ...
                            <div class="containElements">
                                ...
                                <h2 class="primaryTitle">
                                    <span>Aumenta la productividad</span> <br class="space">
        ...
        <section class="sectionParent customSection analiticas-2023_7">
            <div class="section-row">
                ...
                <section class="innerSectionElement sct1">
                    ...
                    <div class=" row groupElements">
                        <div class="col-md-12 col-lg-6 column-image">
                            <div class="containerImage">
                                <img src="{!! App::setFilePath('/assets/images/illustrations/others/08-analiticas_2023.png') !!}" loading="lazy">
                            </div>
                        </div>
                        <div class="col-md-12 col-lg-6 column-text">
                            ...
                            <div class="containElements">
                                ...
                                <h2 class="primaryTitle">
                                    <span>De 0 a 100</span>  ¿Cuán saludable <br class="space">
        ...
        <section class="sectionParent customSection analiticas-2023_8">


            <div style="background-image: url('{!! App::setFilePath('/assets/images/banners/14-analiticas_2023.png') !!}')" class="backgroundFull">

            <div class="section-row">

                <section class="innerSectionElement sct2">
                    <div class="groupElements row">
                        <div class="info col-md-12 col-lg-6 sectionTexts textRight">
                        ...
                        <div class="image col-md-12 col-lg-6">
                            <div class="containerImage">
                                <img src="{!! App::setFilePath('/assets/images/illustrations/others/09-analiticas_2023.png') !!}" loading="lazy">
                            </div>
                        </div>
                    </div>
