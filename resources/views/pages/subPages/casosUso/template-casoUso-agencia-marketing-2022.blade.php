<div id="subPage_casoUso_agencia_marketing">
    <div class="sections">
        ...
        <section id="lead-form" class="component-header-t1 bg-color customSection sectionParent threeCol subPage_casoUso_agencia_marketing_0  ">
                            ...
                            <div class="containElements row threeCol">
                                ...
                                <div class="ele ele1 col-md-12 col-lg-6">
                                    ...
                                    <div class="containerImage">
                                        <img alt="Escala caso de uso marketing" src="{!! App::setFilePath('/assets/images/person/Marketing2 1.png') !!}" loading="lazy">
        ...
        <ul class="text">
            ...
            <li>
                ...
                según el target audience de cada producto/servicio.
            </li>
        ...
        <ul class="text">
            ...
            <li>
                ...
                pages y campañas de email sin necesitar programación.
            </li>
            <li>
                <img src="'. App::setFilePath('/assets/images/illustrations/others/check_positive.png') .'" class="checkCase">
                Centraliza tus campañas de anuncios y landing pages y <br class="DT_e">
                organiza tu base de datos en el CRM de Escala.
            </li>
            <li>
                <img src="'. App::setFilePath('/assets/images/illustrations/others/check_positive.png') .'" class="checkCase">
                Evalúa el interés de tus prospectos con la herramienta de <br class="DT_e">
                Lead Scoring y prioriza a tus potenciales clientes.
            </li>
            <li>
                <img src="'. App::setFilePath('/assets/images/illustrations/others/check_positive.png') .'" class="checkCase">
                ...
                de contacto, venta y post-venta de forma efectiva.
            </li>
        </ul>
        ',
        'enableButton' => false,
                            ...
                            <div class="containElements">
                                ...
                                <div class="formatForm redirectWeb" redirectweb="true">
                                    ...
                                    <script id="escala-form-ffb24e48-3198-4ee5-901c-bfb344fff010-ran09596642574117911dom" data-version="0.1.0">
                                        window["escala-form-ffb24e48-3198-4ee5-901c-bfb344fff010-ran09596642574117911dom"] = {
                                            e: "page",
                                            f: "ffb24e48-3198-4ee5-901c-bfb344fff010",
                                            l: "es",
                                            r: "ran09596642574117911dom"
                                        };

                                        function escInitFormImpl(e) {
                                            ! function() {
                                                var a = window.addEventListener ? "addEventListener" : "attachEvent";
                                                (0, window[a])("attachEvent" === a ? "onmessage" : "message", function(e) {
                                                    if ("escalaForm" === e.data.origin)
                                                        if ("init" === e.data.eventName && e.data.height) {
                                                            const a = document.querySelector('[escala-element-form="escala-form-' + e.data.instance + '"]');
                                                            a && (a.height = e.data.height)
                                                        } else "escala_lead" === e.data.eventName && ("function" == typeof fbq && (e.data.leadData && e.data.leadData.contact_email ? fbq("trackCustom", "escala_lead", {
                                                            email: e.data.leadData.contact_email
                                                        }, {
                                                            eventID: e.data.leadData.deduplicationId
                                                        }) : fbq("trackCustom", "escala_lead", {}, {
                                                            eventID: e.data.leadData.deduplicationId
                                                        })), "function" == typeof gtag && (e.data.leadData && e.data.leadData.contact_email ? gtag("event", "generate_lead", {
                                                            event_category: "engagement",
                                                            event_label: "escala_lead",
                                                            email: e.data.leadData.contact_email
                                                        }) : gtag("event", "generate_lead", {
                                                            event_category: "engagement",
                                                            event_label: "escala_lead"
                                                        })), "undefined" != typeof dataLayer && dataLayer.push && "function" == typeof dataLayer.push && (e.data.leadData && e.data.leadData.contact_email ? dataLayer.push({
                                                            event: "escala_lead",
                                                            email: e.data.leadData.contact_email
                                                        }) : dataLayer.push({
                                                            event: "escala_lead"
                                                ...
                                                var t = "escala-iframe-{f}-{l}-{r}".replace("{f}", e.f).replace("{l}", e.l).replace("{r}", e.r),
                                                    n = document.getElementById(t);
                                                n && n.remove(), n = document.createElement("iframe");
                                                var o = btoa(JSON.stringify({
                                                        loc: location.href,
                                                        title: encodeURIComponent(document.title),
                                                        ref: document.referrer
                                                    })),
                                                    d = (e.f + "-" + e.r + "-" + Math.random()).replace(".", "-"),
                                                    l = "form=" + e.f + "&lang=" + e.l + "&instance=" + d + "&host=" + o + "&v=" + Math.random();
                                                n.setAttribute("src", "https://escalapages.com/plugins/forms/embed.html?" + l);
                                                for (var r = ["marginwidth", "marginheight", "frameborder", "vspace", "hspace"], c = 0; c < r.length; c++) n.setAttribute(r[c], "0");
                                                n.setAttribute("scrolling", "no"), n.width = "100%", n.setAttribute("escala-element-form", "escala-form-" + d), n.setAttribute("id", t);
                                                var i = document.getElementById("escala-form-" + e.f + "-" + e.r),
                                                    m = document.getElementsByTagName("body")[0];
                                                m.contains(i) ? i.parentElement.appendChild(n) : m.appendChild(n)
                                            }()
                                        }

                                        function escInitForm() {
                                            var e = window["escala-form-ffb24e48-3198-4ee5-901c-bfb344fff010-ran09596642574117911dom"];
                                            "elementor-popup" === e.e ? jQuery(document).ready(function() {
                                                jQuery(document).on("elementor/popup/show", () => {
                                                    escInitFormImpl(e)
                                                })
                                            }) : escInitFormImpl(e)
                                        }
                                        window.addEventListener ? window.addEventListener("load", escInitForm, !1) : window.attachEvent ? window.attachEvent("onload", escInitForm) : window.onload = escInitForm;
                                    </script>
                                    <!-- Escala embed form ffb24e48-3198-4ee5-901c-bfb344fff010 -->
