          ...
          - < 100 personas Ejecutivo / Gerente de Éxito<br class="space">
              ...
              <div id="program_alliances">
                  <div class="sections">
                      ...
                      ',
                      'threeCol' => true,
                      'textForm' => ' Conoce Escala en una <br class="space"> sesión personalizada
                      ',
                                              ...
                                              <div class="headerList row">
                                                  ...
                                                  <div style="background-color: #FF4F28" class="element itemCol col-4">
                                                      ...
                                                      <div class="containerImage">
                                                          ...
                                                          '/assets/images/illustrations/others/icon_heart_handshake.png',
                                                          );
                                                          @endphp
                                                  ...
                                                  {{-- onclick="toggleList()"  --}}
                                                  <div
                                                      style="background-color: #01516F"
                                                      class="element itemCol col-4 hideElement closeButtonSection">

                                                      <div class="containerImage">
                                                          @php
                                                          $icon = App::setFilePath(
                                                          '/assets/images/illustrations/others/icon_orientation.png',
                                                          );
                                                          @endphp
                                                          <img src="{!! $icon !!}" loading="lazy">
                                                      </div>
