...
<div id="subPage_pricing_2023">
    <div class="sections">
        ...
        <section class="customSection sectionParent subPage_pricing_2023_0 ">

            <div class="section-row">
                <div style="background-image: url('{{ App::setFilePath('/assets/images/banners/bg-pricing-page-2025-abril.svg') }}')" class="backgroundFull">
                    ...
                    <section class="innerSectionElement sct1">
                        ...
                        <div class="containElements">
                            ...
                            <h1 class="primaryTitle blackColor">
                                Elige el plan según las necesidades de tu empresa
                            </h1>

                            <p class="primaryText grayColorTexts">
                                Cada uno de nuestros planes tiene las funcionalidades de marketing y ventas para acelerar el <br class="DT_e">
                                crecimiento de tu negocio. Solo inviertes en lo que necesitas.
                            </p>
                        ...
                        <div class="containElements">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 col-lg-3 pricingCard starter">
                                    ...
                                    <div class="head">
                                        <h3 class="secondaryTitle blackColor">
                                            Plan <span class="greenBlueColor">Starter</span>
                                        </h3>
                                    </div>
                                                    ...
                                                    <div class="price">
                                                        ...
                                                        <div class="field number">
                                                            ...
                                                            <label for="_usersField">
                                                                Número de <span>usuarios</span> con <br class="DT_e">
                                ...
                                <div class="col-md-12 col-lg-3 pricingCard pro">
                                    ...
                                    <img src="{!! App::setFilePath('/assets/images/illustrations/others/principal_star_2025.png') !!}" alt="" class="principalStar">
                                    ...
                                    <div class="elementBody">
                                        ...
                                        <div class="price">
                                            ...
                                            <span class="cost">
                                                ...
                                                <span class="ahorro discount anualElement aux_visible">
                                                    Pago total de <span>USD 1.164</span> - <span style="font-weight: 700!important; text-decoration:none;"> USD 931.20 / año</span>
                                                </span>
                                            </span>
                                ...
                                <div class="col-md-12 col-lg-3 pricingCard enterprise">
                                    ...
                                    <div class="head">
                                        <h3 class="secondaryTitle blackColor">
                                            Plan <span class="greenBlueColor">Enterprise</span>
                                        </h3>
                                            ...
                                            <form regularPlansCalc onkeydown="if (event.keyCode == 13) { return false; }" action="" id="formCalcGeneral_ENTERPRISE">
                                                ...
                                                <div class=" inputs">
                                                    <div class="price">
                                                        ...
                                                        <div class="field number">
                                                            <input name="_contactsField" class="contactsField" step="1000" type="number" value="100000" min="100000">
        ...
        <section class="customSection sectionParent subPage_pricing_2023_0_1 ">
            <div class="section-row">
                    ...
                    <div class="containElements">
                        ...
                        <div class="row table-header">
                            ...
                            <div class="col-3 col2">
                                <p>Plan <span class="text-blue">Starter</p></span>
                            </div>
                            <div class="col-3 col3">
                                <p>Plan <span class="text-orange">Pro</p>
                            </div>
                            <div class="col-3 col4">
                                <p>Plan <span class="text-blue">Enterprise</p>
                            </div>
                        </div>
                        <div class="row">
        ...
        <section class="customSection sectionParent subPage_pricing_2023_6">
