<div id="acompanamiento-2023">
    <div class="sections">
        ...
        <section style="background-image: url({!! App::setFilePath('/assets/images/banners/02-bg-acompanamiento-2023.png') !!})"
            class="customSection sectionParent acompanamiento-2023-3">
        ...
        <section style="background-image: url({!! App::setFilePath('/assets/images/banners/03-bg-acompanamiento-2023.png') !!})"
            class="customSection sectionParent acompanamiento-2023-5">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row timeFlags">
                                            ...
                                            <div class="col-6 col-lg-3">
                                                ...
                                                <p class="text-time">7 am - 12 pm</p>
                                            </div>
                                            <div class="col-6 col-lg-3">
                                                <div class="container-flags">
                                                    <img class="img-card" src="{!! App::setFilePath('/assets/images/illustrations/others/09-home2023.png') !!}"
                                            ...
                                            <div class="col-6 col-lg-3">
                                                ...
                                                <p class="text-time">10 am - 3 pm</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
        ...
        <section style="background-image: url({!! App::setFilePath('/assets/images/banners/bg-implementacion-2023-02.png') !!})"
            class="sectionParent customSection acompanamiento-2023-8">
