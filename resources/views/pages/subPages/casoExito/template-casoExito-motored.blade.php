<div id="casoExito_motored">
    <div class="sections">
        ...
        <section id="lead-form" class="component-header-t1 bg-image overlay customSection sectionParent fullWidth threeCol casoExito_motored_0 newHome ">


            <div style="background-image: url('{{ App::setFilePath('/assets/images/banners/bg_section_1_motored.svg') }}')" class="backgroundFull">
                                ...
                                <div class="containElements row threeCol">
                                    ...
                                    <div class="ele ele1 col-md-12 col-lg-6">
                                        ...
                                        <div class="containerImage">
                                            <img src="{!! App::setFilePath('/assets/images/person/img_chico_feliz_motored_escala_caso_de_exito.png') !!}" alt="Ilustración Motored" loading="lazy">
                                        </div>
                ...
                <section class="innerSectionElement sct2 right">
                    ...
                    <div class="groupElements row">
                        ...
                        <div class="info col-md-12 col-lg-6">
                            ...
                            <p class="text">
                                Motored es el mayor distribuidor autorizado de <br class="DT_e">
                            ...
                            <div class="containElements">
                                <ul class="itemsList">
                                    ...
                                    <li>
                                        ...
                                        <strong>Website:</strong> <a target="_blank" href="https://heromotored.com/">https://heromotored.com/</a>
        ...
        <section class="customSection sectionParent casoExito_motored_4">
            <div style="background-image: url('{{ App::setFilePath('/assets/images/banners/bg_section_5_motored.svg') }}')" class="backgroundFull">
                    ...
                    <section class="innerSectionElement sct2">
                        ...
                        <div class="containElements left">
                            ...
                            <div class="info">
                                ...
                                <div class="containElements_2">
                                    <p class="text">
                                        Motored configuró reportes a medida para monitorear
                        ...
                        <div class="containElements right">
                            ...
                            <div class="info">
                                ...
                                <div class="containElements_2">
                                    <p class="text">
                                        Los asesores comerciales y líderes de Motored utilizan el <br class="DT_e">
        ...
        <section class="customSection sectionParent casoExito_motored_6">
            ...
            <div class="section-row">
                ...
                <section class="innerSectionElement sct1">
                    <img src="{!! App::setFilePath('/assets/images/banners/bg_section_9_motored.svg') !!}" alt="" class="overlay">

                    <div class="containElements">
                        <div class="row">
                            <div class="col-md-12 col-lg-5 column-img">
                                <div class="img-container">
                                    <img src="{!! App::setFilePath('/assets/images/illustrations/others/ruby_mino_lider_comercial_motored.png') !!}" loading="lazy">
                                </div>
                            </div>
                            <div class="col-md-12 col-lg-7 column-text">
                                <p>
                                    ...
                                    <span class="blue">
                                        Ruby Mino
                                        <br class="space">
                                        <span> Líder Comercial Motored </span>
                                    </span>
        ...
        <section class="customSection sectionParent casoExito_motored_7 backgroundFull" style="background-image: url('{{ App::setFilePath('/assets/images/banners/bg_section_10_motored.svg') }}')">
