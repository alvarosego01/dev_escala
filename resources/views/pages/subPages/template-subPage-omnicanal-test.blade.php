<div id="subPage_omnicanal_test">
    <div class="sections">
        <section id="lead-form" class="hero2025 subPage_omnicanal_test_0_1">
        ...
        <section class="customSection sectionParent subPage_omnicanal_test_1">
        ...
        <section class="customSection sectionParent subPage_omnicanal_test_1_0">
        ...
        <section class="customSection sectionParent subPage_omnicanal_test_1_1">
        ...
        'classSection' => 'subPage_omnicanal_test_2',
        'enableTitle' => true,
        'titlePrincipal' => '
        ...
        $parameters = [
        'type' => 'backgroundColor',
        'classSection' => 'subPage_omnicanal_test_3',
        'enableTitle' => false,
        'titlePrincipal' => null,
        'subTitlePrincipal' => null,
        ...
        $parameters = [
        'type' => 'backgroundColor',
        'classSection' => 'subPage_omnicanal_test_5',
        'enableTitle' => false,
        'titlePrincipal' => null,
        'subTitlePrincipal' => null,
        ...
        <section class="customSection sectionParent subPage_omnicanal_test_6">
        ...
        <section class="customSection sectionParent fullWidth subPage_omnicanal_test_7 ">
            <div class="section-row">
        ...
        <section class="customSection sectionParent subPage_omnicanal_test_8" style="background-image: url('{{ App::setFilePath('/assets/images/banners/bg-omnicanal-section-dk-8-2025.png') }}')">
            <div class="section-row ">
                <div class="containElements">
                    <section class="innerSectionElement sct1">
