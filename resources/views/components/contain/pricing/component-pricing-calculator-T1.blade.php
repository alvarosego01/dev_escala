                                    ...
                                    <div class="rw rw2">
                                        ...
                                        <div class="customSelectorRange">
                                            ...
                                            <div class="slidecontainer">
                                                <input typeProcess="0" name="_rangeContacts" class="rangeContacts" min_aux="1" type="range" min="0"
                                ...
                                <div class="box">
                                    ...
                                    <div class="rw rw2">
                                        ...
                                        <div class="customSelectorRange">
                                            ...
                                            <div class="slidecontainer">
                                                <input typeProcess="1" name="_rangeContacts" class="rangeContacts" min_aux="1" type="range" min="0"
                                                    max="100" value="0" class="sliderSelector">
                                            </div>
