<section style="background-image: url({!! App::setFilePath('/assets/images/banners/bg_nota_prensa_especial.svg') !!})" class="headerband_promo_blue customSection sectionParent fullWidth {{ $classSection }} ">
