...
<div id="func-PageBuilder-bootstrap">
 ...
 $parameters = array(
  ...
  'overlay' => false,
  'classSection' => 'threeCol funcPageBuilder0',
  'title' => 'Crea potentes páginas.<br> <span class="orangeColor">Es tan fácil como copiar y pegar</span>',
  'text' => 'En <span class="orangeColor">escala</span> puedes construir rápidamente landing pages = «websites optimizados» para capturar la información de contacto de tus visitantes, sin necesidad de programar o integrar.',
  'image' => 'https://cdn.escala.com/wp-content/uploads/2020/09/escala-page-builder-creacion-pagina-customizada-768x1003.png',
  'textForm' => '<span class="orangeColor">Acelera </span>tus ventas',
...
@php
 $parameters = array(
  'classSection' => 'funcPageBuilder1 floated',
  'description' => '<strong>"«En las landing pages de Open English generamos más de 1 millón de contactos al año</strong>. Así acumulamos aprendizajes para optimizar nuestras páginas y potenciar nuestras ventas. Basados en una década de experiencia, creamos el Page Builder más robusto del mercado”.".',
  'byAm' => '<span class="orangeColor">Andrés Moreno</span>',
  'team' => 'Fundador de <span class="orangeColor">escala</span> y Open English',
  'image' => 'https://cdn.escala.com/wp-content/uploads/2020/09/escala-Andre%CC%81s-Moreno-founder-Ceo-Open-English-4.png'
 ) ;
@endphp
