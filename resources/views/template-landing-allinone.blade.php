...
{{--
  Template Name: [B] Landing - All in one
--}}
...
<div id="landing-AllInOne-bootstrap">
  <div class="sections">
...
{{--
    ...
    $parameters = array(
     ...
     'overlay' => false,
     'classSection' => 'threeCol landing_AllInOne_0',
 ...
 <section id="lead-form" class="customSection sectionParent landing_AllInOne_0">
  ...
  <div class="section-row">
      ...
      <section class="innerSectionElement sct1">
          ...
          <div class="groupElements row">
              ...
              <div class="info col-md-12 col-lg-7">
                  ...
                  <div class="containElements">
                      ...
                      <h1 class="principalBigTitle blackColor">
                          La plataforma todo en uno <br class="space">
                          <span class="greenBlueColor">de marketing digital y ventas</span>
                      </h1>
                      <p class="principalBigText grayColorTexts">
                          Con Escala, genera más leads, <br class="space">
                          aumenta tus ventas y fideliza <br class="space">
                          más clientes
                      </p>
              ...
              <div class="form7 col-md-12 col-lg-5">
  ...
  <div style="background-image: url('{!! App::setFilePath('/assets/images/overlays/estrellas 2.png') !!}')" class="backgroundPlanets">
    ...
    <section class="customSection sectionParent landing_AllInOne_1">
      <div class="section-row">
        ...
        <section class="innerSectionElement row sct2">
          ...
          <div class="containElements  col-md-12 col-lg-3">
            <div class="elements">
    ...
    <section class="customSection sectionParent landing_AllInOne_2">
    ...
    <section class="customSection sectionParent landing_AllInOne_3 fullWidth">
    ...
    <section class="customSection sectionParent landing_AllInOne_4">
    ...
    <section class="customSection sectionParent landing_AllInOne_5">
    ...
    <section class="customSection sectionParent landing_AllInOne_6">
  ...
  @php
 $parameters = array(
   'classSection' => 'landing_AllInOne_7',
...
<section class="customSection sectionParent landing_AllInOne_8 fullWidth">
