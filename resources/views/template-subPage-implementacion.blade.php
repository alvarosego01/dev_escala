...
@endcontain_text_video_T1
            ...
            @php
                $parameters = [
                    ...
                    'text' => '
                        En Escala te acompañaremos desde el primer día asignándote <br class="DT_e">
                        un gerente de cuenta especializado en marketing digital, ventas <br class="DT_e">
                        y fidelización para que te guíe a conseguir tus objetivos con <br class="DT_e">
                        nuestra plataforma. Desarrolla un plan personalizado para aterrizar tu <br class="DT_e">
...
optimizar comunicaciones
                    ...
                    <section class="innerSectionElement sct3">
                        <div class="containElements">
                            ...
                            <p class="primaryText grayColorTexts">
                                Que tú y tu equipo se beneficien del valor de Escala lo más pronto posible <br class="DT_e">
                                y desarrollen habilidades que los conviertan en Escala Pros <br class="DT_e">
                            </p>
            ...
            @php
                $parameters = [
                  ...
                  ',
                    'text' => '
                Al momento de diseñar tu plan estratégico y táctico con <br class="DT_e">
            ...
            {{-- @php
                $parameters = [
                    ...
                    'title' => '
                        <span class="greenBlueColor">¿Quieres saber qué contiene un <br class="DT_e"></span>
                        plan de implementación?
                  ',
                    'text' => '
                    Revisa estos ejemplos para entender qué puede <br class="DT_e">
                    ...
                    <br class="space"><br class="space">
                    Recuerda que tu plan es personalizado y estará ajustado <br class="DT_e">
            ...
            @php
              ...
              ',
                    ...
                    'text' => '
                Experto en Escala y cómo utilizar la plataforma para generar demanda, <br class="DT_e">
                vender y fidelizar clientes – tu gerente de cuentas es un guía estratégico <br class="DT_e">
                y de proyecto que simplifica la implementación, acelera tu aprendizaje, <br class="DT_e">
                motiva tu progreso y vela porque se usen efectivamente las herramientas <br class="DT_e">
                    ...
                    <section class="innerSectionElement sct3">
                        ...
                        <div class="containElements">
                            ...
                            <div class="info">
                                ...
                                <p class="text">
                                    Cuenta con una librería de capacitaciones <br class="DT_e">
                                    grabadas, más de cien artículos y <br class="DT_e">
                    ...
                    <section class="innerSectionElement sct4">
                        ...
                        <div class="containElements">
                            ...
                            <div class="info">
                                ...
                                <p class="text">
                                    ¿Necesitas apoyo con un tema técnico o con una breve <br class="DT_e">
                                    duda sobre la plataforma? ¡Nuestro equipo de soporte <br class="DT_e">
                                    está para atenderte!
                                </p>
                            </div>
                ...
                $parameters = [
                    ...
                    'elements' => [
                        [
                          ...
                          ',
                            'text' => '
                            ¿No tienes tiempo o necesitas mayor apoyo <br class="DT_e">
                            implementando acciones en Escala? Contrata <br class="DT_e">
                            servicios de migración, diseño de plantillas, <br class="DT_e">
                        ...
                        [
                          ...
                          ',
                            'text' => '
                            Brindamos entrenamiento especializado a tu <br class="DT_e">
                            equipo en la plataforma, nuestra Filosofía de <br class="DT_e">
                            éxito y mejores prácticas de marketing, <br class="DT_e">
  ...
  $items = [
      [
          ...
          'text' => '
            Con el servicio de implementación recibes acompañamiento personalizado de un Gerente de Cuenta asignado para que, desde el día 1, <br class="DT_e">
      ...
      [
          ...
          'text' => '
            El proceso de implementación de Escala consta de 4 fases que tú y tu equipo culminan a su propio ritmo bajo la guía de su Gerente de <br class="DT_e">
            ...
            <li>Se definen las primeras tareas a ejecutar en la plataforma y se acuerdan las próximas sesiones con el Gerente de Cuenta y los <br class="DT_e"> especialistas pertinentes del equipo de servicio de Escala (Soporte, diseño de plantillas, migración, etc.).</li>
            </ul>
            <br class="space"><br class="space">
            ...
            <li>Tu Gerente de Cuenta te guía a personalizar el CRM según los requerimientos de tu negocio y te apoyamos a migrar activos digitales <br class="DT_e"> como tu base de datos, formularios y automatizaciones.</li>
            ...
            <li>Ten en cuenta que las fases 1 y 2 suelen culminarse en un periodo máximo de 2 semanas, siempre que brindes la información <br class="DT_e"> necesaria y trabajes en conjunto con tu Gerente de Cuenta.</li>
            </ul>
            <br class="space"><br class="space">
            <p class="text"><strong>Fase 3 Producción</strong></p>
            <br class="space">
            <ul style="list-style: disc; padding-left: 20px">
                <li>Tú y tu equipo crearán piezas (landing pages, anuncios, plantillas de email), programarán automatizaciones y desarrollarán <br class="DT_e"> habilidades para empezar a generar leads y ventas con Escala.</li>
                <li>Tu Gerente de Cuenta te guía para que segmentes y organices tu base de datos, implementes mejores prácticas al crear campañas <br class="DT_e"> de marketing, y entrenes a tu equipo comercial y/o de servicio para que usen efectivamente el CRM.</li>
            ...
            <br class="space">
            <ul style="list-style: disc; padding-left: 20px">
                <li>Después de una o dos semanas de activar tu campaña y empezar a vender con Escala, podrás revisar resultados con tu Gerente de <br class="DT_e"> cuenta gracias a los Dashboards y métricas que brinda Escala.</li>
      ...
      [
          ...
          <ul style="list-style: disc; padding-left: 20px">
            ...
            Usualmente, tendrás 8 horas disponibles con tu Gerente de Cuenta para culminar la implementación. Estas horas las consumes a tu <br class="DT_e"> propio ritmo, en un máximo de 3 meses.
            <br class="space">
            <br class="space">
            Dependiendo de la complejidad del negocio, el progreso y compromiso de tu equipo, pueden recibir hasta 15 horas de acompañamiento <br class="DT_e"> en el período de implementación. Esto lo acuerdas con tu Gerente de Cuenta y Escala se reserva el derecho de aprobar o no la extensión.</li>
            <br class="space">
            ...
            Además de tu gerente de cuentas, en Escala cuentas con entrenadores durante capacitaciones en vivo semanales que puedes atender <br class="DT_e"> ilimitadamente y representantes de servicio al cliente por chat en plataforma, email y WhatsApp.</li>
          </ul>
        ...
        [
          ...
          'text' => '
          <ul style="list-style: disc; padding-left: 20px">
            <li>Podrás comunicarte con tu Gerente de Cuenta y tendrás una hora al mes para revisar tus actividades, planificar tus nuevos proyectos, <br class="DT_e"> implementar nuevas funcionalidades y más.</li>
            ...
            <li>Si tú y/o tu equipo llegan a necesitar mayor apoyo, puedes contratar servicios profesionales adicionales de consultoría, diseño, <br class="DT_e"> implementación y capacitación.</li>
          </ul>
          '
        ],
        [
          ...
          'text' => '
            En Escala hay plantillas tanto de landing pages como de emails. Tu equipo puede tomar cualquier diseño de nuestra galería de plantillas, <br class="DT_e">
            modificar muy fácilmente el texto que deseen y publicarlas, sin necesitar un equipo de programación.
            <br class="space"><br class="space">
            De necesitar mayor apoyo, puedes contratar a nuestro equipo de diseño para recibir plantillas personalizadas y maquetadas en Escala, <br class="DT_e">
        ...
        [
          ...
          'text' => '
            Sigue los pasos para obtener el diseño de plantillas <br class="DT_e">
        ...
        [
          'type' => 'master',
          'title' => '¿Qué hago en los encuentros con mi gerente de cuenta luego del período de <br class="DT_e"> implementación?',
          'text' => '
            La fase de optimización es extendida; esto quiere decir que mes a mes podrás analizar con tu Gerente de Cuenta qué hacer para mejorar <br class="DT_e">
            tus resultados y optimizar el uso de la plataforma.
            <br class="space"><br class="space">
            También puedes pedirle apoyo en planificar acciones según tus metas de negocio, incorporar nuevas estrategias, o bien, pedirle asesoría <br class="DT_e">
