...
<div id="bootstrap-escala-subpages-marketing-2">
  <div class="sections">
    <section id="lead-form" class="component-header-t1 bg-color customSection sectionParent threeCol escalaMarketing2Section0  ">
              ...
              <div class="containElements row threeCol">
                ...
                <div class="ele ele1 col-md-12 col-lg-6">
                  ...
                  <div class="containerImage">
                    <img src="{!! App::setFilePath('/assets/images/illustrations/others/tablet_marketing_1.png') !!}" loading="lazy">
    ...
    <section id="lead-form-bottom" class="component-bannerForms7-t1 bg-color customSection sectionParent escalaMarketing2Section6 ">
          ...
          <div class="groupElements row">
            ...
            <div class="info col-md-12 col-lg-6">
              ...
              <div class="containElements">
                ...
                <div class="containerImage">
                  <img src="{!! App::setFilePath('/assets/images/person/hombre_puf_emailmk_1.png') !!}" alt="" loading="lazy">
