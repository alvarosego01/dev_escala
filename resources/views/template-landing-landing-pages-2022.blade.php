    ...
    $parameters = [
        ...
        'elements' => [
            [
                ...
                'title' => '<span class="whiteColor">
                    Botón de WhatsApp <br class="desktopTabletElement"> integrado
                    </span>',
            ...
            [
                ...
                'title' => '<span class="whiteColor">
                    Cuentan con formularios <br class="desktopTabletElement"> integrados
                    </span>',
                'text' => 'Cada vez que un visitante registra sus datos en el <br class="desktopTabletElement"> formulario de tu landing page, quedan guardados <br class="desktopTabletElement"> automáticamente en tu CRM de Escala.<br class="space"> ¡No pierdas ningún dato!',
                'enableButton' => false,
            ],
    ...
    <div class="section-row">
          ...
          <section class="innerSectionElement1">
            ...
            <h2 class="primaryTitle blackColor">
              Nuestros clientes te dicen qué tan fácil <br class="desktopTabletElement"> es crear landing pages con Escala
            </h2>
