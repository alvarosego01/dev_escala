...
@php
 $parameters = array(
  ...
  'text' => 'Una de las claves para crear anuncios exitosos es escoger <br> correctamente el público al que deseas dirigir tus campañas de <br> mercadeo. En escala encuentras las herramientas que necesitas <br> para segmentar y aprovechar al máximo el poder de los medios <br> digitales.',
  'enableButton' => false,
  // 'urlButton' => '#lead-form',
...
@php
 $parameters = array(
  ...
  'text' => 'Despierta tu creatividad creando anuncios de Facebook e Instagram fácilmente en escala.
  <br class="space"><br class="space">
Simplemente agrega textos que enganchen, escoge un titular irresistible, y selecciona la foto o el video que mejor comunique
...
@php
 $parameters = array(
  ...
  'text' => 'Con escala, publicar tus campañas en Facebook e Instagram es <br> fácil y rápido.
  <br class="space"><br class="space">
¡Solo necesitas un click!
<br class="space"><br class="space">
Siéntate, relájate y observa cómo tus anuncios hacen su magia <br> para traer tráfico a tus páginas.',
  'enableButton' => false,
  // 'urlButton' => '#lead-form',
...
@php
 $parameters = array(
  ...
  'text' => 'Monitorea en tiempo real el rendimiento de tus campañas de <br> anuncios digitales con escala ¿Cuántas personas han visto tu <br> anuncio? ¿Cuál es tu costo por click?
  <br class="space"><br class="space">
Lo que no se mide no mejora. Conoce lo que funciona, aprende de <br> lo que no y mejora con ello tus resultados.',
  'enableButton' => true,
  'urlButton' => '#lead-form',
...
@php
 $parameters = array(
  ...
  ',
  'text' => '<strong>Crea y maneja potentes campañas digitales en <span class="orangeColor">escala</span></strong>
  <br class="space"><br class="space">
Imagina poder saber: qué campaña de anuncios digitales generó <br> más visitas a tu landing page, qué segmentación de audiencia <br> generó más contactos, qué anuncio generó más clientes, ¡y mucho <br> más!
<br class="space"><br class="space">
...
<br class="space"><br class="space">
Las páginas creadas en escala ya vienen con el Pixel de Facebook <br> integrado.',
  'enableButton' => false,
  // 'urlButton' => '#lead-form',
