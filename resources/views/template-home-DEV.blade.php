...
<div id="homeBootstrap_DEV">
    ...
    ',
      ...
      ',
        ...
        'backgroundImageType' => true,
        'overlay' => false,
        'classSection' => 'D_e threeCol homeSection_DEV_0 newHome',
        'title' => '
        Acelera el crecimiento <br class="space">
        <span style="color: #DEF3F5">de tu empresa con Escala</span>
        ',
        ...
        'backgroundImageType' => true,
        'overlay' => false,
        'classSection' => 'MT_e threeCol homeSection_DEV_0 newHome',
        'title' => '
        Acelera el crecimiento <br class="space">
        <span style="color: #DEF3F5">de tu empresa con Escala</span>
        ',
        ...
        'text' =>
        '<span style="color:#34768a">Si tienes dudas sobre cualquier cosa puedes:</span> <br class="D_e">
        ...
        'text' =>
        'Escala Academy es el programa de formación constante, mediante el cual te daremos todo el conocimiento de marketing digital y <br class="D_e"> ventas para hacerte un experto. <br class="space"><br class="space"> Escala Academy: <br class="D_e">
        <ul style="color:#34768a" class="accordionSpecial">
